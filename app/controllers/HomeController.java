...
public class HomeController extends Controller {
    ...
    public String saveFile(Long id, FilePart<File> uploaded){
        ...
        if(mimeType.startsWith("image/")){
            ...
            //we must make sure that the directories exsistbefore running the operations
            // String extension = "";
            ...
            // // directory)
            // File file = uploaded.getFile();
            // we must make sure that the directory for the images excist before we save it
            File dir = new File("public/images/productImages/thumbnails/");
            if(!dir.exists()){
                dir.mkdirs();
            }
            // move the file to the required location (in a real application
            // the path tp where images are stored would be configurable, but
